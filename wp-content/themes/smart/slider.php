...
<link rel="stylesheet" href="<?php bloginfo( 'template_url' ); ?>/css/slider_style.css" />
    
<!-- js -->
<script src="<?php bloginfo( 'template_url' ); ?>/js/jquery-1.9.1.min.js"></script>
<script src="<?php bloginfo( 'template_url' ); ?>/js/jquery.cslide.js" type="text/javascript"></script>
<script>
